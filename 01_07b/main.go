...
// The TASK
/* Given a string mathematical expression implement a function that outputs if the
expression has balanced brackets.
*/

// operatorType represents the type of operator is an expression
